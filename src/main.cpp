...
static const int64 nTargetTimespan = 0.25 * 24 * 60 * 60; // Franko: every 4 hours
static const int64 nTargetSpacing = 0.5 * 60; // Franko: 30 seconds
