...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // Subsidy is cut in half every 112358 blocks, which will occur approximately every 4 years
    nSubsidy >>= (nHeight / 112358); // franko: 112358k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 0.25 * 24 * 60 * 60; // franko: 4x a day
static const int64 nTargetSpacing = 0.5 * 60; // franko: 0.5 minutes
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "5/9/2013 In two months from today Aiden will be a year old.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0xbf618e70eb8bab5ddce2ec4c5f86b3a645e2eb39bbf57d3ea7bd681d992539fd"));
